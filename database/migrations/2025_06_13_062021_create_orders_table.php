...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->decimal('total_price', 9)->default(0.00)->comment('总支付金额');
            $table->decimal('order_price', 9)->default(0.00)->comment('订单计算金额');
            $table->decimal('order_balance', 9)->default(0.00)->comment('余额支付金额');
            $table->decimal('freight_money', 5)->default(0.00)->comment('运费金额');
            $table->decimal('coupon_money', 5)->default(0.00)->comment('优惠金额');
