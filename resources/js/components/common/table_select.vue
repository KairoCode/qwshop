    ...
    <div class="table_select">
        ...
        >
            <table-view
                ...
                :handleHide="params.handleHide || false"
                :searchOption="params.searchOptions"
        ...
        <el-button :icon="Finished" @click="openTabel">{{
            $t("btn.select")
        }}</el-button>
    ...
    setup(props, { emit }) {
        ...
        const selectRow = (e, rows) => {
            ...
            if (!props.params.many) {
                ...
                if (proxy.R.isEmpty(rows[0][data.defaultShowName]))
                    data.defaultShowName = "goods_name";
                if (proxy.R.isEmpty(rows[0][data.defaultShowName]))
                    data.defaultShowName = "nickname";
