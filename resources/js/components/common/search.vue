    ...
    <div class="search_layout">
        <el-row :gutter="20" v-if="options.length > 0" class="search_layout2">
            <el-col
                ...
                :md="8"
                :lg="4"
                v-for="(v, k) in advanced ? optionsRef.slice(0, 5) : optionsRef"
                :key="k"
            >
                    ...
                    <q-input
                        ...
                        :dictData="
                            ...
                            dictData[v.value]
                                ...
                                : v.data || {}
                        "
                        v-model:formData="searchParams[v.value]"
                    />
            ...
            <el-col :sm="24" :md="8" :lg="4">
                <div class="search-content">
                    ...
                    <el-button
                        type="text"
                        v-if="optionsRef.length > 5"
                        @click="advanced = !advanced"
                        >{{ advanced ? $t("btn.open") : $t("btn.shrink") }}
                        <i
                            :class="
                                advanced
                                    ? 'el-icon-arrow-down'
    ...
    setup(props, content) {
        ...
        const searchSubmit = async () => {
            ...
            propOptions.map((optionItem) => {
                if (
                    newParams[optionItem.value] &&
                    optionItem.where !== null &&
                    optionItem.where !== undefined
                ) {
