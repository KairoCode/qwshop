            ...
            <div class="shop_logo float_left">
                <router-link to="/"
                    ><img
                        width="242px"
                        height="74px"
                        :title="data.common.index_name || ''"
                        :src="
                            data.common.logo ||
                            require('@/assets/Home/logo.png').default
                        "
                /></router-link>
            </div>
                        ...
                        <div class="index_my_car">
                            ...
                            <span
                                ><router-link to="/carts"
                                    >我的购物车<el-icon
                                        ><i
                                            class="fa fa-shopping-cart" /></el-icon
                                ></router-link>
                                <div class="shop_car_dot">
                                    {{ data.cart || 0 }}
                                </div></span
                            >
                        </div>
        ...
        <div class="shop_top_nav">
            <div class="center1200">
                <div
                    ...
                    @mouseover="classClick(true)"
                    @mouseleave="classClick(false)"
                >
                    全部商品
                    <transition name="el-zoom-in-top"
                        ><leftBar
                            ...
                            v-show="
                                data.subnav
                                    ? data.subnav && data.subnavBool
                                    : data.subnavBool && data.subnavBool2
                            "
                        ></leftBar
                    ></transition>
                </div>
                <div class="shop_top_nav_right">
                    <ul>
                        ...
                        <li>
                            <router-link to="/user/article/帮助中心"
                                >帮助中心</router-link
                            >
                        </li>
                    </ul>
...
export default {
    ...
    setup(props) {
        ...
        onMounted(() => {
            if (
                !proxy.R.isEmpty(route.params.params) &&
                route.path.indexOf("/s/") > -1
            ) {
                data.keywords = decodeURIComponent(
                    JSON.parse(window.atob(route.params.params)).keywords
                );
        ...
        watch(
            ...
            (e) => {
                if (!proxy.R.isEmpty(e) && route.path.indexOf("/s/") > -1) {
                    data.keywords = decodeURIComponent(
                        JSON.parse(window.atob(e)).keywords
                    );
                    if (data.keywords == "undefined") data.keywords = "";
                }
            }
