    ...
    <div :class="changeColor ? 'leftbar2' : 'leftbar'">
        <ul>
            <li
                ...
                v-for="(v, k) in data.goodsClass"
                :key="k"
            >
                <div class="class_1">
                    <a @click="toNav(v.id, v)" href="javascript:;">{{
                        v.name
                    }}</a>
                </div>
                <div class="class_2">
                    <ul>
                        <li
                            ...
                            v-show="key < 3"
                        >
                            <a @click="toNav(v.id, vo, 1)">{{ vo.name }}</a>
                        </li>
                    </ul>
                </div>
                <div class="subbar">
                    ...
                    <div class="subbar_right">
                        <ul>
                            <li
                                v-for="(
                                    goods_brand_item, goods_brand_key
                                ) in data.goodsBrand || []"
                                :key="goods_brand_key"
                            >
                                <img
                    ...
                    <div class="subbar_subnav">
                        ...
                        >
                            ...
                            <ul>
                                <li
                                    v-for="(item, index) in vo.children"
                                    :key="index"
                                >
                                    <a @click="toNav(v.id, item, 2)">{{
                                        item.name
                                    }}</a>
                                </li>
                            </ul>
