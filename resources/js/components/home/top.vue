        ...
        <div class="head_in">
                    ...
                    <li>
                        <router-link
                            ...
                            ><img
                                ...
                                :src="
                                    require('@/assets/order/address_pos3.png')
                                        .default
                                "
                            />{{ " " + data.city + " " || " - " }}</router-link
                        >
                    </li>
                </ul>
            </div>
            <div class="top_shop_right">
                <ul>
                    ...
                    <li v-show="isLogin">
                        欢迎您，<router-link to="/" style="color: #ca151e">{{
                            data.users.nickname || "-"
                        }}</router-link>
                    </li>
                    ...
                    <li>|</li>
                    <li>
                        <router-link to="/store/join" style="color: #ca151e"
                            >商家入驻</router-link
                        >
                    </li>
                    <li>|</li>
...
export default {
    setup() {
        ...
        const isLogin = computed(
            () => store.state.login.loginData[routeUriIndex].isLogin
        );
        ...
        const loadCity = () => {
            try {
                ...
                proxy.R.get(
                    amapUrl,
                    { key: amapKey.value, ip: ip.value, type: 4 },
                    true
                ).then((res) => {
