                    ...
                    <div class="admin_card">
                        ...
                        <div class="content">
                            <div class="total_price">
                                {{ $t("btn.money") }}
                                {{ data.info.total_price || "0.00" }}
                            </div>
                            <div class="total_rate">
                                <span
                                    >周同比
                                    {{ data.info.week_rate || "0.00" }}
                                    %<el-icon
                                        v-if="data.info.week_rate >= 0"
                                ...
                                <span
                                    >日同比
                                    {{ data.info.day_rate || "0.00" }} %<el-icon
                                        v-if="data.info.day_rate >= 0"
                                        style="margin-left: 5px; color: red"
                                        ><CaretTop /></el-icon
                                    ><el-icon
                                        v-else
                            ...
                            <div class="month_rate">
                                <el-progress
                                    :percentage="data.info?.month_rate || 60.0"
                                    color="#67c23a"
                                />
                            </div>
                            <div class="today_price">
                                日销售额：{{ $t("btn.money") }}
                                {{ data.info.today_price || "0.00" }}
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <el-row :gutter="12">
                                ...
                                >
                                    <div class="color_block">
                                        ...
                                        <div class="color_blcok_font">
                                            {{ data.info.order_wait || "0" }}
                                        </div>
                                    </div>
                                </el-col>
                                <el-col
                    ...
                    <div class="admin_card">
                        ...
                        <div class="content" style="margin-top: 0">
                            <div class="copyright">
                                ...
                                <span class="copyright_rs"
                                    ><a
                                        target="_blank"
                                        href="https://github.com/qingwuit/qwshop"
                                        ><img
                                            ...
                                            style="
                                                ...
                                                height: 18px;
                                            "
                                            src="https://img.shields.io/packagist/v/qingwuit/qwshop" /></a
                                ></span>
                            </div>
                            <div class="unline"></div>
                            <div class="copyright">
                                <span class="copyright_title">商城框架：</span>
                                <span class="copyright_rs" @click="openWeb"
                                    >青梧商城系统（QwSystem）</span
                                >
                            </div>
                            <div class="unline"></div>
            ...
            <div class="admin_card">
                <div class="title">
                    <div class="right_block">
                        <ul>
                            <li
                                :class="params.is_type == 0 ? 'ck' : ''"
                                @click="typeChange(0)"
                            >
                                本周
                            </li>
                            <li
                                :class="params.is_type == 1 ? 'ck' : ''"
                                @click="typeChange(1)"
                            >
                                本年
                            </li>
                    ...
                    <el-row :gutter="22">
                        ...
                        <el-col :span="8">
                            <div class="sort_list">
                                ...
                                <div class="list_block" v-for="v in 6" :key="v">
                                    <em style="color: #999; float: right">{{
                                        data.list[v - 1]
                                            ? data.list[v - 1]["orders_count"]
                                            : "-"
                                    }}</em
                                    ><span>{{ v }}</span>
                                    <div
...
import baseView from "@/components/common/base.vue";
        ...
        const loadData = () => {
            proxy.R.get("/Admin/dashboard/all", params).then((res) => {
                if (!res.code) {
                    ...
                    data.orderPlot.forEach(
                        (item) => (item.num = parseFloat(item.num))
                    );
...
.admin_card .sort_list .list_block span,
...
.admin_card .sort_list .list_title,
.admin_form .sort_list .list_title {
    margin-bottom: 10px;
    margin-top: 10px;
    font-weight: bold;
}
.admin_card .sort_list .list_block,
.admin_form .sort_list .list_block {
    padding: 10px 10px;
    overflow: hidden;
}
.admin_card .sort_list .list_block:nth-child(1) span,
.admin_form .sort_list .list_block:nth-child(1) span {
    background: #333;
    color: #fff;
}
.admin_card .sort_list .list_block:nth-child(2) span,
.admin_form .sort_list .list_block:nth-child(2) span {
    background: #333;
    color: #fff;
}
.admin_card .sort_list .list_block:nth-child(3) span,
.admin_form .sort_list .list_block:nth-child(3) span {
    background: #333;
    color: #fff;
}
.admin_card .sort_list .list_block:nth-child(4) span,
.admin_form .sort_list .list_block:nth-child(4) span {
    background: #333;
    color: #fff;
}
.admin_card .default_gd {
    height: 320px;
    margin-top: 20px;
    margin-bottom: 20px;
}
