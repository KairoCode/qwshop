...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'cloudErp:install';
     ...
     * @var string
     */
    protected $description = 'Cloud Erp Install Command';
    ...
    public function handle(): bool
    {
        ...
        Artisan::call('cloudErp:mysql'); // 导入数据结构
        $this->line('');
        ...
        $this->line('');
        $this->line('');
        $this->info('Install Successfully , Welcome CloudErp.');
        $this->line('');
    ...
    // 修改env
    public function modifyEnv(array $data): void
    {
